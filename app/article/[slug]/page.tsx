...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      title: article.title,
      description: article.excerpt,
      url: `https://charlesperalo.com/article/${article.slug}`,
      type: "article",
    ...
    <div style={{ background: "var(--bg)" }}>
      ...
      <section className="section-pad" style={{ background: "linear-gradient(180deg, var(--bg-card) 0%, var(--bg) 100%)", borderBottom: "1px solid var(--border)" }}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <span className="tag tag-red mb-5 inline-flex">{article.category}</span>
          <h1
            className="article-headline mb-5"
      ...
      <section className="py-14 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 article-body">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mt-14 pt-8" style={{ borderTop: "1px solid var(--border)" }}>
      ...
      <section className="py-14" style={{ background: "var(--bg-card)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          <div className="overline mb-3">Free Newsletter</div>
          <h2 className="font-display text-2xl sm:text-3xl mb-3" style={{ color: "var(--text-primary)" }}>Enjoyed This Article?</h2>
          <p className="text-sm mb-8" style={{ color: "var(--text-secondary)" }}>Get more insights like this delivered to your inbox every morning.</p>
      ...
      {related.length > 0 && (
        <section className="section-pad">
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="overline mb-3">More Reading</div>
            <h2 className="section-headline mb-8" style={{ color: "var(--text-primary)" }}>More in {article.category}</h2>
